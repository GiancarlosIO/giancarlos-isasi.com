...
contentPreview: "Esta es una collección del código repetitivo que suelo usar dentro de mis proyectos personales. La lista irá crecimiento conforme vaya descubriendo
nuevas cosas."
createdAt: "26/06/2021"
categories: "go, gorm, snippets"
---

Esta es una collección del código repetitivo que suelo usar dentro de mis proyectos personales. La lista irá crecimiento conforme vaya descubriendo
nuevas cosas.<br/>Puedes revisar la documentación completa en [gorm.io](https://gorm.io/).
...
## Agregar validaciones de campo requerido a una tabla (Validations)
```go
package models
import (
	"gorm.io/gorm"
