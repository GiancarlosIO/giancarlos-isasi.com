...
---
Recientemente en @crehana tuvimos la necesidad de prohibir el uso de un tag de html. Esto porque tenemos un componente, llamado CustomNextImage, que usa el next/image internamente y agrega ciertas optimizaciones y mejoras a la imagen usada.
